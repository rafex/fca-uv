...
<head>
  ...
  <!-- full calendar css-->
  <link href="${path}assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css" rel="stylesheet" />
  <link href="${path}assets/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
  <!-- easy pie chart-->
  ...
  <link href="${path}css/jquery-jvectormap-1.2.2.css" rel="stylesheet">
  <!-- Custom styles -->
  <link rel="stylesheet" href="${path}css/fullcalendar.css">
  <link href="${path}css/widgets.css" rel="stylesheet">
  <link href="${path}css/style.css" rel="stylesheet">
  <link href="${path}css/style-responsive.css" rel="stylesheet" />
  <link href="${path}css/xcharts.min.css" rel=" stylesheet">
  <link href="${path}css/jquery-ui-1.10.4.min.css" rel="stylesheet">
  ...
  <!-- charts scripts -->
  <script src="${path}assets/jquery-knob/js/jquery.knob.js"></script>
  ...
  <script src="${path}assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
  <!--script for this page only-->
  <script src="${path}js/calendar-custom.js"></script>
  <script src="${path}js/jquery.rateit.min.js"></script>
  <!-- custom select -->
  ...
  <script src="${path}js/xcharts.min.js"></script>
  ...
  <script src="${path}js/sparklines.js"></script>
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                  <span class="photo"><img id="avatar" alt="avatar" src="${path}img/avatar-mini.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                  <span class="photo"><img alt="avatar" src="${path}img/avatar-mini2.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                  <span class="photo"><img alt="avatar" src="${path}img/avatar-mini3.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                  <span class="photo"><img alt="avatar" src="${path}img/avatar-mini4.jpg"></span>
                                    <span class="subject">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <table class="table bootstrap-datatable countries">
                  ...
                  <tr>
                    <td><img src="${path}img/India.png" style="height:18px; margin-top:-2px;"></td>
                    <td>India</td>
                    <td>3652</td>
                    <td>2563</td>
                    <td>
                  ...
                  <tr>
                    <td><img src="${path}img/Spain.png" style="height:18px; margin-top:-2px;"></td>
                    <td>Spain</td>
                    <td>562</td>
                    <td>452</td>
                    <td>
                  ...
                  <tr>
                    <td><img src="${path}img/Germany.png" style="height:18px; margin-top:-2px;"></td>
                    <td>Brazil</td>
                    <td>265</td>
                    <td>102</td>
                    <td>
                  ...
                  <ul class="chats">
                    ...
                    <li class="by-other">
                      ...
                      <div class="avatar pull-right">
                        <img src="${path}img/user22.png" alt=""/>
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                                <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="${path}img/avatar1_small.jpg">
                                        Jenifer smith
                                </span>
                  </div>
                </div>
...
<script type="text/javascript" src="${path}js/panel.js"></script>
</body>
</html>
