...
public class RestClient {
	...
	// private final static Boolean proxyActive = (Boolean)
	// PropertiesReader.get("VAR.PROXY.ACTIVE");
	// private final static String proxyPassword = (String)
	// PropertiesReader.get("VAR.PROXY.PASSWORD");
	// private final static String proxyUser = (String)
	// PropertiesReader.get("VAR.PROXY.USER");
	// private final static String proxyHost = (String)
	// PropertiesReader.get("VAR.PROXY.HOST");
	// private final static Integer proxyPort = (Integer)
	// PropertiesReader.get("VAR.PROXY.PORT");

	private final static Boolean cacheActive = UtilidadPropiedades.obtenerBooleano("VAR.CACHE.ACTIVE");
	private final static Boolean proxyActive = UtilidadPropiedades.obtenerBooleano("VAR.CACHE.ACTIVE");
	...
	private static Proxy proxy() {
		...
		final ProxyDto proxy = new ProxyDto.ProxyBuilder("host","port").build();
		...
		return new Proxy(Proxy.Type.HTTP, new InetSocketAddress(proxy.getHost(), proxy.getPortInt()));
	}
}
